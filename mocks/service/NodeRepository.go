...
func (_m *NodeRepository) GetNode(id string) (*v1.Node, bool) {
	ret := _m.Called(id)
...
func (_m *NodeRepository) GetNodes() map[string]*v1.Node {
	ret := _m.Called()
...
func (_m *NodeRepository) GetNodesByLabels(labels v1.NodeLabels) map[string]*v1.Node {
...
func (_m *NodeRepository) StoreNode(id string, node v1.Node) error {
