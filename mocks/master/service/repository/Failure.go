...
func (_m *Failure) Delete(id string) {
	_m.Called(id)
}

// Get provides a mock function with given fields: id
func (_m *Failure) Get(id string) (*v1.Failure, bool) {
	ret := _m.Called(id)
...
func (_m *Failure) GetAll() []*v1.Failure {
	ret := _m.Called()
...
func (_m *Failure) GetAllByNode(nodeID string) []*v1.Failure {
...
func (_m *Failure) GetNotStaleByNode(nodeID string) []*v1.Failure {
	ret := _m.Called(nodeID)
...
func (_m *Failure) Store(failure *v1.Failure) error {
