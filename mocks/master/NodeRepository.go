...
func (_m *NodeRepository) GetNode(id string) (*master.Node, bool) {
	ret := _m.Called(id)
...
func (_m *NodeRepository) GetNodes() map[string]*master.Node {
	ret := _m.Called()
...
func (_m *NodeRepository) StoreNode(id string, node *master.Node) error {
