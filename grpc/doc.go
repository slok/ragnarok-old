...
// Node status protos
//go:generate protoc -I. -I.. -I${GOOGLEPROTO_PATH} nodestatus/nodestatus.proto --go_out=plugins=grpc:.

// Failure protos
//go:generate protoc -I. -I.. failurestatus/failurestatus.proto --go_out=plugins=grpc:.
